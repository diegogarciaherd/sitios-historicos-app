...
def run(): 
    ...
    site1 = sites.create_sites(
        ...
        categoria="Histórico",
        localizacion=WKTElement('POINT(-34.9214 -57.9544)')
    )   
    ...
    site2 = sites.create_sites(
        ...
        categoria="Histórico",
        localizacion=WKTElement('POINT(-34.6015 -58.3816)')
    )
    ...
    site3 = sites.create_sites(
        ...
        categoria="Gobierno",
        localizacion=WKTElement('POINT(-34.6083 -58.3712)')
    )
    ...
    site4 = sites.create_sites(
        ...
        localizacion=WKTElement('POINT(-26.8083 -65.2175)')
    )
    ...
    site5 = sites.create_sites(
        ...
        categoria="Cultural",
        localizacion=WKTElement('POINT(-34.6083 -58.3750)')
    )
    ...
    site7 = sites.create_sites(
        ...
        categoria="Religioso",
        localizacion=WKTElement('POINT(-34.5667 -59.1167)')
    )
    ...
    site8 = sites.create_sites(
        ...
        categoria="Histórico",
        localizacion=WKTElement('POINT(-32.4833 -58.2333)')
    )
    ...
    site9 = sites.create_sites(
        ...
        categoria="Histórico",
        localizacion=WKTElement('POINT(-31.5375 -68.5364)')
    )
    ...
    site10 = sites.create_sites(
        ...
        localizacion=WKTElement('POINT(-31.6667 -64.4333)')
    )
    ...
    site11 = sites.create_sites(
        ...
        categoria="Gobierno",
        localizacion=WKTElement('POINT(-31.4201 -64.1888)')
    )
    ...
    site12 = sites.create_sites(
        ...
        categoria="Monumento",
        localizacion=WKTElement('POINT(-32.9442 -60.6505)')
    )
    ...
    site15 = sites.create_sites(
        ...
        localizacion=WKTElement('POINT(-34.6103 -58.3636)')
    )
    ...
    site19 = sites.create_sites(
        ...
        categoria="Cultural",
        localizacion=WKTElement('POINT(-24.7821 -65.4232)')
    )
