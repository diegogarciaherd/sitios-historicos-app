  ...
  <div class="min-h-screen bg-gray-100 flex flex-col">
    ...
    <div class="flex-1 flex flex-col gap-4 pt-20 sm:pt-24 lg:pt-28 px-4 sm:px-6 lg:px-8 pb-4">
      <div class="max-w-7xl mx-auto w-full flex flex-col gap-4">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Listado Sitios Históricos</h1>
        ...
        <div class="flex flex-col lg:flex-row gap-4">
          ...
          <div class="flex-1 flex flex-col gap-4">
            <SearchBar ref="searchBarRef" v-model="searchTerm" @search="handleSearch" />

            <SiteGrid :siteFilters="combinedFilters" :page="page" @change-page="handlePageChange" />
          </div>
        </div>
      </div>
    </div>
